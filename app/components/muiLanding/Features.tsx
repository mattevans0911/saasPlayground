...
const items = [
  {
    ...
    description:
      "This item could provide an overview of the AI image recognition.",
    imageLight:
  ...
  },
  {
    ...
    description:
      "This item could provide information about the condition-based pricing feature of the product.",
    imageLight:
